...
function todosIguales(array) {
   ...
   // Tu código:
   var elementosIguales = array.every(
      (elemento) => elemento === array[0]
   );
...
function tablaDelSeis() {
   ...
   // Tu código:
   var multiplicacionPorSeis = [];
   for (i=0 ; i<11 ; i++) {
      multiplicacionPorSeis.push(i*6);
   }
   return multiplicacionPorSeis;
}
...
function continueStatement(num) {
   ...
   for (var i=0 ; i<10 ; i++) {
      if (i === 5) {
         ...
         valor = valor +2;
         continueSalto.push(valor);
         
      }
   }
   return continueSalto;
